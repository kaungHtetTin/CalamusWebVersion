		...
		<div class="container">
			<div class="row justify-content-lg-center justify-content-md-center">
				...
				<div class="col-lg-6 col-md-8">
					<div class="sign_form">
						<h2>Welcome to Calamus Education</h2>
						...
						<form method="post" action="">
							...
							<div class="ui search focus mt-15">
								<div class="ui left icon input swdh11 swdh19">
									<input class="prompt srch_explore" type="phone" name="phone" value="" id="phone" required="" maxlength="64" placeholder="Phone (09123456789)">															
								</div>
							</div>
							<div class="ui search focus mt-15">
								<div class="ui left icon input swdh11 swdh19">
							...
							<button class="login-btn" type="submit">Join Now</button>
						</form>
