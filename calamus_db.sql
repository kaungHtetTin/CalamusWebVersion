...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2026 at 01:26 PM
...
CREATE TABLE `conversations` (
  ...
  `user1_id` int(10) UNSIGNED NOT NULL COMMENT 'First user in conversation',
  `user2_id` int(10) UNSIGNED NOT NULL COMMENT 'Second user in conversation',
...
CREATE TABLE `courses` (
  ...
  `certificate_code` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `learners` (
  `id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  `learner_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `learner_email` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `learner_phone` bigint(20) NOT NULL,
  `password` varchar(225) COLLATE utf8mb4_unicode_ci NOT NULL,
  `learner_image` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cover_image` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `gender` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bd_day` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bd_month` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bd_year` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `otp` int(11) NOT NULL,
  `auth_token` varchar(225) COLLATE utf8mb4_unicode_ci NOT NULL,
  `auth_token_mobile` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `lessons` (
  ...
  `cate` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `posts` (
  ...
  `body` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `blog_title` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `post_like` int(11) NOT NULL,
  `comments` int(11) NOT NULL,
  `image` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `video_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vimeo` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `roadmaps` (
  ...
  `checklist` longtext CHARACTER SET utf8mb4 NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `songs` (
  ...
  `drama` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `project_settings`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `project_settings_key_unique` (`key`);
...
ALTER TABLE `user_learning_progress`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_user_language_deck` (`user_id`,`language_id`,`deck_id`),
  ADD KEY `idx_language_id` (`language_id`),
  ADD KEY `idx_deck_id` (`deck_id`);
...
ALTER TABLE `user_roadmaps`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_roadmaps_user_id` (`user_id`);
